...
def test_target(args):
    ...
    netF.load_state_dict(torch.load(args.modelpath, weights_only=True))
    args.modelpath = args.output_dir_src + '/source_B.pt'
    netB.load_state_dict(torch.load(args.modelpath, weights_only=True))
    args.modelpath = args.output_dir_src + '/source_C.pt'
    netC.load_state_dict(torch.load(args.modelpath, weights_only=True))
    netF.eval()
    netB.eval()
    netC.eval()
